...
;                   through macros rather than procedures (Practice Program Jeff Dntemann)
;
; Build using these commands:
;   nasm -f elf -g -F stabs eatmacro.asm
;   ld -m elf_i386 -s -o eatmacro eatmacro.o
;
;
...
%macro WriteStr 2    ; ; %1 = String address; %2 = string length
    ...
    push ebx
    mov ecx,%1       ; Pit string address into ECX
