...
;        or ld -m elf_i386 -s -o uppercaser uppercaser.o
;
SECTION .bss              ; Section containing uninitialized data
    BUFFLEN equ 1024      ; Length of bffer
    Buff:   resb BUFFLEN  ; Text bffer itself (resb?)
...
_start:
    ...
    read:
        ...
        mov ebx, 0        ; Specify File Desc 0: Standard Input
